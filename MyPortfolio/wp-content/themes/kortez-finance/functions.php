 ...
 *
 * @package Kortez Finance
 */

require get_stylesheet_directory() . '/inc/customizer/customizer.php';
require get_stylesheet_directory() . '/inc/customizer/loader.php';

if ( ! function_exists( 'kortez_finance_enqueue_styles' ) ) :
	/**
	 * @since Kortez Finance 1.0.0
	 */
	function kortez_finance_enqueue_styles() {
		wp_enqueue_style( 'kortez-finance-style-parent', get_template_directory_uri() . '/style.css',
			array(
				'bootstrap',
				'slick',
				'slicknav',
...
add_action( 'wp_enqueue_scripts', 'kortez_finance_enqueue_styles', 10 );


if( !function_exists( 'kortez_finance_footer_layout_filter' ) ){
    /**
    ...
    * @return array
    */
    add_filter( 'kortez_footer_layout_filter', 'kortez_finance_footer_layout_filter' );
    function kortez_finance_footer_layout_filter( $footer_layout ){
        $added_footer = array(
...
* 
* @since Kortez Finance 1.2.1
* @return array.
*/
function kortez_finance_get_pages(){
...
if( !function_exists( 'kortez_finance_blog_advertisement_banner' ) ){
	/**
	* Add a blog advertisement banner
	* @since Kortez Finance 1.0.0
	*/
    function kortez_finance_blog_advertisement_banner(){
